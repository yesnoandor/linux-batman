...
#define		GB905_UPDATE_METER_DEVICE_TYPE				0x02
#define		GB905_UPDATE_METER_VENDOR_ID				0x06
#define		GB905_UPDATE_METER_HW_VERSION				0X01
#define		GB905_UPDATE_METER_SW_VERSION				0X0104

bool gb905_update_meter_version_check(void)
{
	bool ret = true;
	int sw_version;
	...
	if(update_info.base_info.vendor_id != GB905_UPDATE_METER_VENDOR_ID)
	{
	...
	if(update_info.base_info.vendor_id != GB905_UPDATE_METER_HW_VERSION)
	{
	...
	if(sw_version <= GB905_UPDATE_METER_SW_VERSION)
	{
...
void gb905_update_meter_start(void)
{
	bool ret;
